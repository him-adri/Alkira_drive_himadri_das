...
function SideBar({ id }) {
  ...
  return (
    <>
      {loading ? (
        <p><h3 className="loading">Kindly Wait your data is loading🔃</h3></p>
      ) : (
        <>
          ...
          <p className="random-details"><b>Random Game Details: </b></p>
          <div className="flex-div">
            <p><b>Date:</b></p>
            <p>{details.date}</p>
          </div>
